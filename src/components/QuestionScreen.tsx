...
export function QuestionScreen({ 
  ...
  return (
    <div className="p-6 md:p-8 bg-white">
      ...
      {/* Instruction banner */}
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-emerald-500 text-emerald-700 p-4 rounded-r-lg text-center mb-8 shadow-sm">
        <div className="flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
          </svg>
          <span className="font-medium">Select the missing words in the correct order</span>
        </div>
      </div>
            ...
            <span key={index}>
              ...
              {index < sentenceParts.length - 1 && (
                <span 
                  ...
                  className={`inline-block mx-1 px-3 py-1 rounded-md border-2 transition-all duration-200 ${
                    userAnswers[index] 
      ...
      {/* Word options */}
      <div className="mb-10">
        <h3 className="text-sm font-medium text-gray-500 mb-3">Select words to complete the sentence:</h3>
